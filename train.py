...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='YOLOV5/yolov5-SimAM/covid/covid_model/yolov5s-SimAM.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='YOLOV5/yolov5-SimAM/covid/covid_parameter/parameter.yaml', help='dataset.yaml path')
